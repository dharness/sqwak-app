...
class ExploreClassCard extends Component {
  ...
  render() {
    ...
    return (
      <div
        className={
          "sq-class-card sq-class-card__explore" +
          (this.props.isBeingCopied ? " loading" : "") +
          (this.isCopied ? " is-copied" : "")
        }
      >
        ...
        <div
          className={
            "sq-class-card__explore--copy-button" +
            (this.props.isBeingCopied ? " loading" : "")
          }
        >
          <PlushButton
            loadingText=" "
            isLoading={this.props.isBeingCopied}
            buttonText={"Copy"}
            colorClass={"sq-button__blue"}
            onClick={this.onCopyClicked.bind(this)}
          />
        </div>
        <div className="sq-class-card--num-samples sq-text__sm">
          {this.props.mlClass.numSamples}{" "}
          {pluralize("sample", this.props.mlClass.numSamples)}
        </div>
      </div>
    );
  }
